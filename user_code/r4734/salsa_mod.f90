...
!--          Obtain time index for current point in time.
             ...
             IF (aero_emission_att%time(aero_emission_att%tind) > time_since_reference_point )  THEN
...
!--    Obtain time index for current point in time.
       ...
       IF ( gas_emission_time(chem_emission_att%i_hour) > time_since_reference_point )  THEN
