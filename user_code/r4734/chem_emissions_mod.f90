...
! Current revisions:
! ------------------
! Add necessary stuff for salsa+simple
! 
! Former revisions:
! -----------------
...
!***************************************************************************************************
! Added by MONA 17 Jul 2020:
             CASE ( 'OCNV' );  chem_emis_att%xm(ispec) = 150.0_wp
...
!-- Import timestamps from netCDF input
    ...
    CALL get_dimension_length ( ncid, fld_len, 'field_len' )
    !!CALL get_dimension_length ( ncid, fld_len, 'field_length' ) MONA
