...
! Former revisions:
! -----------------
! $Id: chemistry_model_mod.f90 4403 2020-02-12 13:08:46Z banzhafs $
...
!*******************************************************************************
! MONA:
    REAL(wp) ::  skip_time_do_chemistry = 0.0_wp   !< starting time of chemistry
!*******************************************************************************
!
...
!--    Calculate overall budget for surface m and adapt concentration
       DO  lsp = 1, nspec
          ...
          bud(lsp) = surf_lsm_h%frac(ind_veg_wall,m) * bud_luv(lsp) + &
               surf_lsm_h%frac(ind_pav_green,m) * bud_lup(lsp) + &
               surf_lsm_h%frac(ind_wat_win,m) * bud_luw(lsp)
!
